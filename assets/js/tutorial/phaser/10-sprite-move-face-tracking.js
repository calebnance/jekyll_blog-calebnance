window.onload = function() {
  ...
  // set allow movement to false for tracking face example
  ...
  tracker.on('track', function(event) {
    ...
    // uncomment below for visual face mapping
  ...
  function preload() {
    ...
    game.load.spritesheet('goku-4-panel', '/assets/img/phaser/sprite/sprite-goku-4-panel.png', 32, 32, 4);
  }
